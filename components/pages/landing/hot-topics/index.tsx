...
const HotTopics: React.FC = () => {
  return (
    <section className="container mx-auto px-6 lg:px-0">
      <div className="flex flex-col gap-[50px] w-full max-w-[1456px] mx-auto">
        {/* First Section: Hot Topics in Astrology & Current News */}
        <div className="relative border border-[#4a494b] rounded-[49px] py-[37px] px-[72px] flex flex-col items-center gap-6 max-w-full">
          <h2 className="font-mukta font-bold text-[32px] leading-[0.875em] tracking-[2%] text-center text-[#691709] m-0">
            Hot Topics in Astrology & Current News
          </h2>
          <p className="font-mukta font-normal text-[24px] leading-[1.5em] tracking-[2%] text-center text-[#79787a] m-0 max-w-[1323px]">
        ...
        <div className="relative border border-[#4a494b] rounded-[49px] py-[38px] px-[57px] flex flex-col items-center gap-6 max-w-full">
          <h2 className="font-mukta font-bold text-[32px] leading-[0.875em] tracking-[2%] text-center text-[#691709] m-0">
            Know about Astrology
          </h2>
          <p className="font-mukta font-normal text-[24px] leading-[1.5em] tracking-[2%] text-center text-[#79787a] m-0 max-w-[1369px]">
