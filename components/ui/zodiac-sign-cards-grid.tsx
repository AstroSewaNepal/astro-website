...
export function ZodiacSignCardsGrid<T>({
  ...
  const showCarouselNavButtons = showCarouselNav && !showCustomPaginationBar && cards !== 'loading' && cards.length > 1;
  const swiperPagination = showCustomPaginationBar ? false : pagination ?? {
    clickable: true,
  };
