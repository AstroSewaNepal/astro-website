  ...
  return (
    <section className="w-full px-0 lg:px-0">
      ...
      <p className="mt-[10px] md:mt-6 font-mukta font-normal text-[14px] leading-[1.2] tracking-[0.02em] md:text-[16px] lg:text-[18px] text-[#4a423d]">
        Enter birth details for both partners to get a complete compatibility report with Guna Milan
        score, Dosha analysis, and Ashtakoot breakdown.
      </p>
      ...
      <p className="text-[16px] leading-6 md:text-[24px] md:leading-[34px] font-normal font-mukta text-Paragraph w-full mb-8 md:mb-10 text-justify">
        Kundali matching, also called Kundali Milan or horoscope matching, is a Vedic method for
        assessing compatibility between two people before marriage. It compares both birth charts
        across eight compatibility categories, known as Ashtakoot, to produce a score out of 36. A
        score of 18 or above is generally considered sufficient for a compatible match. Higher
        scores indicate stronger alignment across more areas of life.
      </p>
