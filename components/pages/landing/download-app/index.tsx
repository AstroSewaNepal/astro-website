...
const DownloadApp: React.FC<DownloadAppProps> = ({ className }) => {
  return (
    <section className={clsx(className, 'w-full px-0 border-b border-b-[#79787A] pb-[100px]')}>
      <div className="w-full max-w-full mx-auto flex flex-col items-center justify-between gap-8 px-4 py-8 md:gap-12 md:px-6 md:py-12 lg:flex-row lg:items-center lg:gap-24 lg:px-4 lg:py-16 xl:gap-36">
        {/* Left Content */}
