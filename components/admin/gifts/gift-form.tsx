...
const schema = z.object({
  ...
  prices: z.object({
    npr: z.coerce.number().min(0, 'Must be 0 or greater'),
    inr: z.coerce.number().min(0, 'Must be 0 or greater'),
    usd: z.coerce.number().min(0, 'Must be 0 or greater'),
  }),
});

export type GiftFormValues = z.infer<typeof schema>;
...
export default function GiftForm({
  ...
  const form = useForm<GiftFormValues>({
    resolver: zodResolver(schema) as Resolver<GiftFormValues>,
    defaultValues: {
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input {...field} placeholder="e.g. Rose" className="font-mukta" />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
